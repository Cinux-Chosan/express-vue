"undefined"!=typeof window&&(window.PR_SHOULD_USE_CONTINUATION=!0),function(){function e(e,t,n,r,a){n&&(r(e={h:e,l:1,j:null,m:null,a:n,c:null,i:t,g:null}),a.push.apply(a,e.g))}function t(e){for(var t=void 0,n=e.firstChild;n;n=n.nextSibling){var r=n.nodeType
t=1===r?t?e:n:3===r&&m.test(n.nodeValue)?e:t}return t===e?void 0:t}function n(t,n){var r,a={};(function(){for(var e=t.concat(n),l=[],s={},i=0,o=e.length;i<o;++i){var u=e[i],c=u[3]
if(c)for(var p=c.length;0<=--p;)a[c.charAt(p)]=u
c=""+(u=u[1]),s.hasOwnProperty(c)||(l.push(u),s[c]=null)}l.push(/[\0-\uffff]/),r=function(e){function t(e){var t=e.charCodeAt(0)
if(92!==t)return t
var n=e.charAt(1)
return(t=p[n])?t:"0"<=n&&"7">=n?parseInt(e.substring(1),8):"u"===n||"x"===n?parseInt(e.substring(2),16):e.charCodeAt(1)}function n(e){return 32>e?(16>e?"\\x0":"\\x")+e.toString(16):"\\"===(e=String.fromCharCode(e))||"-"===e||"]"===e||"^"===e?"\\"+e:e}function r(e){var r=e.substring(1,e.length-1).match(RegExp("\\\\u[0-9A-Fa-f]{4}|\\\\x[0-9A-Fa-f]{2}|\\\\[0-3][0-7]{0,2}|\\\\[0-7]{1,2}|\\\\[\\s\\S]|-|[^-\\\\]","g"))
e=[]
var a=["["];(l="^"===r[0])&&a.push("^")
for(var l=l?1:0,s=r.length;l<s;++l){var i,o=r[l];/\\[bdsw]/i.test(o)?a.push(o):(o=t(o),l+2<s&&"-"===r[l+1]?(i=t(r[l+2]),l+=2):i=o,e.push([o,i]),65>i||122<o||(65>i||90<o||e.push([32|Math.max(65,o),32|Math.min(i,90)]),97>i||122<o||e.push([-33&Math.max(97,o),-33&Math.min(i,122)])))}for(e.sort(function(e,t){return e[0]-t[0]||t[1]-e[1]}),r=[],s=[],l=0;l<e.length;++l)(o=e[l])[0]<=s[1]+1?s[1]=Math.max(s[1],o[1]):r.push(s=o)
for(l=0;l<r.length;++l)o=r[l],a.push(n(o[0])),o[1]>o[0]&&(o[1]+1>o[0]&&a.push("-"),a.push(n(o[1])))
return a.push("]"),a.join("")}function a(e){for(var t=e.source.match(RegExp("(?:\\[(?:[^\\x5C\\x5D]|\\\\[\\s\\S])*\\]|\\\\u[A-Fa-f0-9]{4}|\\\\x[A-Fa-f0-9]{2}|\\\\[0-9]+|\\\\[^ux0-9]|\\(\\?[:!=]|[\\(\\)\\^]|[^\\x5B\\x5C\\(\\)\\^]+)","g")),a=t.length,i=[],o=0,u=0;o<a;++o){var c=t[o]
"("===c?++u:"\\"===c.charAt(0)&&(c=+c.substring(1))&&(c<=u?i[c]=-1:t[o]=n(c))}for(o=1;o<i.length;++o)-1===i[o]&&(i[o]=++l)
for(u=o=0;o<a;++o)"("===(c=t[o])?i[++u]||(t[o]="(?:"):"\\"===c.charAt(0)&&(c=+c.substring(1))&&c<=u&&(t[o]="\\"+i[c])
for(o=0;o<a;++o)"^"===t[o]&&"^"!==t[o+1]&&(t[o]="")
if(e.ignoreCase&&s)for(o=0;o<a;++o)e=(c=t[o]).charAt(0),2<=c.length&&"["===e?t[o]=r(c):"\\"!==e&&(t[o]=c.replace(/[a-zA-Z]/g,function(e){return e=e.charCodeAt(0),"["+String.fromCharCode(-33&e,32|e)+"]"}))
...
d.push("(?:"+a(c)+")")}return new RegExp(d.join("|"),i?"gi":"g")}(l)})()
var l=n.length
return function t(i){for(var o=i.i,u=i.h,c=[o,"pln"],p=0,d=i.a.match(r)||[],f={},g=0,h=d.length;g<h;++g){var m,y=d[g],v=f[y],b=void 0
if("string"==typeof v)m=!1
else{var x=a[y.charAt(0)]
if(x)b=y.match(x[1]),v=x[0]
else{for(m=0;m<l;++m)if(x=n[m],b=y.match(x[1])){v=x[0]
...
b[2]&&(w=(S=y.length-b[2].length)-m.length),v=v.substring(5),e(u,o+x,y.substring(0,w),t,c),e(u,o+x+w,m,s(v,m),c),e(u,o+x+S,y.substring(S),t,c)}else c.push(o+x,v)}i.g=c}}function r(e){var t=[],r=[]
...
u&&(t=o.substring(0,u.index),e.nodeValue=t,(o=o.substring(u.index+u[0].length))&&e.parentNode.insertBefore(i.createTextNode(o),e.nextSibling),a(e),t||e.parentNode.removeChild(e))}}else if("br"===e.nodeName.toLowerCase())a(e),e.parentNode&&e.parentNode.removeChild(e)
...
break}if(p=o.className,(u!==x||h.test(p))&&!m.test(p)){for(w=!1,C=o.parentNode;C;C=C.parentNode)if(b.test(C.tagName)&&C.className&&h.test(C.className)){w=!0
break}if(!w){var w,S
if(o.className+=" prettyprinted",(w=u.lang)||(!(w=p.match(g))&&(S=t(o))&&v.test(S.tagName)&&(w=S.className.match(g)),w&&(w=w[1])),y.test(o.tagName))C=1
else{var C=o.currentStyle,N=r.defaultView
C=(C=C?C.whiteSpace:N&&N.getComputedStyle?N.getComputedStyle(o,null).getPropertyValue("white-space"):0)&&"pre"===C.substring(0,3)}(N="true"===(N=u.linenums)||+N)||(N=!!(N=p.match(/\blinenums\b(?::(\d+))?/))&&(!N[1]||!N[1].length||+N[1])),N&&a(o,N,C),i({j:w,h:o,m:N,l:C,a:null,i:null,c:null,g:null})}}}f<s.length?c.setTimeout(n,250):"function"==typeof e&&e()})()}}
"function"==typeof(b=c.define)&&b.amd&&b("google-code-prettify",[],function(){return x})}()
