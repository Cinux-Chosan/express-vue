...
for(var r=0;r<t.length;r++)(n=t[r]).updatedDisplay=n.mustUpdate&&j(n.cm,n.update)
var n
...
else if(t<=i.viewFrom)(o=$t(e,r,r+n,1))?(i.view=i.view.slice(o.index),i.viewFrom=o.lineN,i.viewTo+=n):_t(e)
else if(r>=i.viewTo){var o;(o=$t(e,t,t,-1))?(i.view=i.view.slice(0,o.index),i.viewTo=o.lineN):_t(e)}else{var l=$t(e,t,t,-1),s=$t(e,r,r+n,1)
...
if(!a||e.which&&!(e.which<10)||!pr(t,e))(function(e,t,r){return dr(e,"'"+r+"'",t,function(t){return fr(e,t,!0)})})(t,e,String.fromCharCode(null==n?r:n))||t.display.input.onKeyPress(e)}}function br(e){"nocursor"!=e.options.readOnly&&(e.state.focused||(Ri(e,"focus",e),e.state.focused=!0,To(e.display.wrapper,"CodeMirror-focused"),e.curOp||e.display.selForContextMenu==e.doc.sel||(e.display.input.reset(),o&&setTimeout(function(){e.display.input.reset(!0)},20)),e.display.input.receivedFocus()),qe(e))}function wr(e){e.state.focused&&(Ri(e,"blur",e),e.state.focused=!1,ko(e.display.wrapper,"CodeMirror-focused")),clearInterval(e.display.blinker),setTimeout(function(){e.state.focused||(e.display.shift=!1)},150)}function xr(e,t){Qt(e.display,t)||function(e,t){if(!ji(e,"gutterContextMenu"))return!1
return tr(e,t,"gutterContextMenu",!1,Ri)}(e,t)||e.display.input.onContextMenu(t)}var Cr=x.changeEnd=function(e){return e.text?ue(e.from.line+e.text.length-1,no(e.text).length+(1==e.text.length?e.from.ch:0)):e.to}
...
else(g=l(1,u.length-1)).push(new En(h+c.text.slice(a.ch),d,n)),o(c,c.text.slice(0,s.ch)+u[0],i(0)),e.insert(s.line+1,g)
