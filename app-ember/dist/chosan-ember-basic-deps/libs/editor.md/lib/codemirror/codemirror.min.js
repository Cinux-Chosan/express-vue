...
for(var r=0;r<t.length;r++)(n=t[r]).updatedDisplay=n.mustUpdate&&X(n.cm,n.update)
var n
...
else if(t<=i.viewFrom)(o=qt(e,r,r+n,1))?(i.view=i.view.slice(o.index),i.viewFrom=o.lineN,i.viewTo+=n):Yt(e)
else if(r>=i.viewTo){var o;(o=qt(e,t,t,-1))?(i.view=i.view.slice(0,o.index),i.viewTo=o.lineN):Yt(e)}else{var l=qt(e,t,t,-1),s=qt(e,r,r+n,1)
...
if(!a||e.which&&!(e.which<10)||!gr(t,e))(function(e,t,r){return pr(e,"'"+r+"'",t,function(t){return hr(e,t,!0)})})(t,e,String.fromCharCode(null==n?r:n))||t.display.input.onKeyPress(e)}}function wr(e){"nocursor"!=e.options.readOnly&&(e.state.focused||(Bi(e,"focus",e),e.state.focused=!0,Mo(e.display.wrapper,"CodeMirror-focused"),e.curOp||e.display.selForContextMenu==e.doc.sel||(e.display.input.reset(),o&&setTimeout(function(){e.display.input.reset(!0)},20)),e.display.input.receivedFocus()),Ze(e))}function xr(e){e.state.focused&&(Bi(e,"blur",e),e.state.focused=!1,To(e.display.wrapper,"CodeMirror-focused")),clearInterval(e.display.blinker),setTimeout(function(){e.state.focused||(e.display.shift=!1)},150)}function Cr(e,t){Jt(e.display,t)||function(e,t){if(!Xi(e,"gutterContextMenu"))return!1
return rr(e,t,"gutterContextMenu",!1,Bi)}(e,t)||e.display.input.onContextMenu(t)}var Sr=x.changeEnd=function(e){return e.text?ce(e.from.line+e.text.length-1,io(e.text).length+(1==e.text.length?e.from.ch:0)):e.to}
...
else(g=l(1,u.length-1)).push(new Fn(h+c.text.slice(a.ch),d,n)),o(c,c.text.slice(0,s.ch)+u[0],i(0)),e.insert(s.line+1,g)
