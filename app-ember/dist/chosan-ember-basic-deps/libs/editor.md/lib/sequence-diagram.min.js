...
for(var w,x,u,p,_,y,f,g,b,E={};;){if(u=i[i.length-1],this.defaultActions[u]?p=this.defaultActions[u]:(null==w&&(d=void 0,"number"!=typeof(d=t.lexer.lex()||c)&&(d=t.symbols_[d]||d),w=d),p=n[u]&&n[u][w]),void 0===p||!p.length||!p[0]){var k
